...
src/mem-mgr: src/mpointers/libmpointers.a
src/mem-mgr: src/memory_manager/libmemory_manager.a
src/mem-mgr: /usr/lib/libgrpc++_unsecure.so.1.60.0
src/mem-mgr: /usr/lib/libgrpc_unsecure.so.37.0.0
src/mem-mgr: /usr/lib/libprotobuf.so
src/mem-mgr: src/proto/libproto_lib.a
src/mem-mgr: /usr/lib/libgrpc++.so.1.60.0
src/mem-mgr: /usr/lib/libgrpc.so.37.0.0
src/mem-mgr: /usr/lib/libupb_json_lib.so.37.0.0
src/mem-mgr: /usr/lib/libupb_textformat_lib.so.37.0.0
src/mem-mgr: /usr/lib/libssl.so
src/mem-mgr: /usr/lib/libcrypto.so
src/mem-mgr: /usr/lib/libprotobuf.so
src/mem-mgr: /usr/lib/libupb_collections_lib.so.37.0.0
src/mem-mgr: /usr/lib/libupb.so.37.0.0
src/mem-mgr: /usr/lib/libutf8_range_lib.so.37.0.0
src/mem-mgr: /usr/lib/libz.so
src/mem-mgr: /usr/lib/libabsl_statusor.so.2308.0.0
src/mem-mgr: /usr/lib/libcares.so.2.19.3
src/mem-mgr: /usr/lib/libaddress_sorting.so.37.0.0
src/mem-mgr: /usr/lib/libgpr.so.37.0.0
src/mem-mgr: /usr/lib/libsystemd.so
